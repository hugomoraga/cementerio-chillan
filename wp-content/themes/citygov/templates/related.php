...
if ( !function_exists( 'citygov_template_related_theme_setup' ) ) {
	add_action( 'citygov_action_before_init_theme', 'citygov_template_related_theme_setup', 1 );
	function citygov_template_related_theme_setup() {
		citygov_add_template(array(
			'layout' => 'related',
			'mode'   => 'blog',
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /no columns/', 'citygov'),
		...
		citygov_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /2 columns/', 'citygov'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'citygov'),
			'w'		 => 370,
			'h'		 => 370
		));
		citygov_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /3 columns/', 'citygov'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'citygov'),
			'w'		 => 370,
			'h'		 => 370
		));
		citygov_add_template(array(
			...
			'need_columns' => true,
			'need_terms' => true,
			'title'  => esc_html__('Related posts /4 columns/', 'citygov'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'citygov'),
			'w'		 => 370,
			'h'		 => 370
		));
...
// Template output
if ( !function_exists( 'citygov_template_related_output' ) ) {
	function citygov_template_related_output($post_options, $post_data) {
		$show_title = true;
