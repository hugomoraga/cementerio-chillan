...
if ( !function_exists( 'citygov_template_news_portfolio_theme_setup' ) ) {
	add_action( 'citygov_action_before_init_theme', 'citygov_template_news_portfolio_theme_setup', 1 );
	function citygov_template_news_portfolio_theme_setup() {
		citygov_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'citygov'),
...
// Template output
if ( !function_exists( 'citygov_template_news_portfolio_output' ) ) {
	function citygov_template_news_portfolio_output($post_options, $post_data) {
