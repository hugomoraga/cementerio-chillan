...
if ( !function_exists( 'citygov_template_team_4_theme_setup' ) ) {
	add_action( 'citygov_action_before_init_theme', 'citygov_template_team_4_theme_setup', 1 );
	function citygov_template_team_4_theme_setup() {
		citygov_add_template(array(
			'layout' => 'team-4',
			'template' => 'team-4',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 4/', 'citygov'),
...
// Template output
if ( !function_exists( 'citygov_template_team_4_output' ) ) {
	function citygov_template_team_4_output($post_options, $post_data) {
		$show_title = true;
