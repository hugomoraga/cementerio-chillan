...
if ( !function_exists( 'citygov_template_testimonials_1_theme_setup' ) ) {
	add_action( 'citygov_action_before_init_theme', 'citygov_template_testimonials_1_theme_setup', 1 );
	function citygov_template_testimonials_1_theme_setup() {
		citygov_add_template(array(
			'layout' => 'testimonials-1',
			'template' => 'testimonials-1',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 1/', 'citygov'),
			'thumb_title'  => esc_html__('Avatar (no small)', 'citygov'),
			'w'		 => 240,
			'h'		 => 240
		));
	}
...
// Template output
if ( !function_exists( 'citygov_template_testimonials_1_output' ) ) {
	function citygov_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
