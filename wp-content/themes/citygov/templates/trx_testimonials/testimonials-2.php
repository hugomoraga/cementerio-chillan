...
if ( !function_exists( 'citygov_template_testimonials_2_theme_setup' ) ) {
	add_action( 'citygov_action_before_init_theme', 'citygov_template_testimonials_2_theme_setup', 1 );
	function citygov_template_testimonials_2_theme_setup() {
		citygov_add_template(array(
			'layout' => 'testimonials-2',
			'template' => 'testimonials-2',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 2/', 'citygov')
		));
	}
}

// Template output
if ( !function_exists( 'citygov_template_testimonials_2_output' ) ) {
	function citygov_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
