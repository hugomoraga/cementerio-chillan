...
if ( !function_exists( 'citygov_template_testimonials_3_theme_setup' ) ) {
	add_action( 'citygov_action_before_init_theme', 'citygov_template_testimonials_3_theme_setup', 1 );
	function citygov_template_testimonials_3_theme_setup() {
		citygov_add_template(array(
			'layout' => 'testimonials-3',
			'template' => 'testimonials-3',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 3/', 'citygov'),
			'thumb_title'  => esc_html__('Avatar (small)', 'citygov'),
			'w'		 => 75,
			'h'		 => 75
		));
	}
...
// Template output
if ( !function_exists( 'citygov_template_testimonials_3_output' ) ) {
	function citygov_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
