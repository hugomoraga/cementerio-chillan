...
if ( !function_exists( 'citygov_template_services_4_theme_setup' ) ) {
	add_action( 'citygov_action_before_init_theme', 'citygov_template_services_4_theme_setup', 1 );
	function citygov_template_services_4_theme_setup() {
		citygov_add_template(array(
			'layout' => 'services-4',
			'template' => 'services-4',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 4/', 'citygov')
		));
	}
}

// Template output
if ( !function_exists( 'citygov_template_services_4_output' ) ) {
	function citygov_template_services_4_output($post_options, $post_data) {
