...
if ( !function_exists( 'citygov_template_services_1_theme_setup' ) ) {
	add_action( 'citygov_action_before_init_theme', 'citygov_template_services_1_theme_setup', 1 );
	function citygov_template_services_1_theme_setup() {
		citygov_add_template(array(
			'layout' => 'services-1',
			'template' => 'services-1',
			'mode'   => 'services',
			'title'  => esc_html__('Services /Style 1/', 'citygov'),
...
// Template output
if ( !function_exists( 'citygov_template_services_1_output' ) ) {
	function citygov_template_services_1_output($post_options, $post_data) {
