...
if ( !function_exists( 'citygov_template_services_2_theme_setup' ) ) {
	add_action( 'citygov_action_before_init_theme', 'citygov_template_services_2_theme_setup', 1 );
	function citygov_template_services_2_theme_setup() {
		citygov_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'citygov'),
...
// Template output
if ( !function_exists( 'citygov_template_services_2_output' ) ) {
	function citygov_template_services_2_output($post_options, $post_data) {
