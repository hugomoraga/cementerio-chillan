<table class="form-table">
	...
	<tr>
		<th></th>
		<td>
			<a href="https://studiowombat.com/kb-category/business-hours-indicator/" target="_blank"><?php _e('Read the documentation','business-hours-indicator');?></a> <?php _e('to find out all available options for shortcodes','business-hours-indicator');?>.
		</td>
	</tr>
</table>